...
import { BiCart, BiCricketBall, BiFootball, BiHeart, BiLogIn, BiLogOut, BiLogoProductHunt, BiShoppingBag, BiUser, BiX } from "react-icons/bi";
...
const Navbaar = () => {
  ...
  return (
    <>
     ...
     {/* --------------------------------------------navbar---------------------------------------- */}
      <div className="flex flex-wrap place-items-center absolute top-0 left-0 right-0  py-2">
        <div className="absolute inset-0 bg-black opacity-40"></div>
        <section className="relative mx-auto w-full">
          <nav className="flex justify-start  text-white  ">
            ...
            <div
                  ...
                  className="flex items-center xl:hidden  hover:text-gray-200 mr-4"
